...
function AsyncChain() {
    ...
    this.onErrorFn = function (e) {
        console.log("onError: " + e.name);
    }
};

AsyncChain.prototype.onError = function (onErrorFn) {
...
AsyncChain.prototype.getNext = function () {
    ...
    return function () {
        try {
            ...
            console.log("e =" + e);
            args[0].onErrorFn(e); // ведь в args теперь хранится ссылка на контекст нашего AsyncMaster
        }
    }
};
