...
function ButtonBuilder(game) {
    this.game = game;
}

ButtonBuilder.prototype.newButton = function (x, y, callback, context, idleFramePage, idleFrameName, pressedFrameName) {
...
ButtonBuilder.prototype.settingsButton = function (x, y, callback, context) {
...
ButtonBuilder.prototype.newGameButton = function (x, y, callback, context) {
    return this.newButton(x, y, callback, context,
...
ButtonBuilder.prototype.hintButton = function (x, y, callback, context) {
